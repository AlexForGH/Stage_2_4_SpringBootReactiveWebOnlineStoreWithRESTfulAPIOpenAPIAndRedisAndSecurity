# Stage_2_3_SpringBootReactiveWebOnlineStoreWithRESTfulAPIOpenAPIAndRedis

![Демо работы](./demo.gif)

## *EN*
#### Link to the previous project based on the Spring Boot and reactive technology stack: https://github.com/AlexForGH/Stage_2_2_SpringBootReactiveWebOnlineStore.git
#### Link to the following project based on the Spring Boot and reactive technology stack with RESTful API, Open API and Spring Data Redis and Spring Security: https://github.com/AlexForGH/Stage_2_4_SpringBootReactiveWebOnlineStoreWithRESTfulAPIOpenAPIAndRedisAndSecurity.git
...
## *RU*
#### Ссылка на предыдущий проект на основе Spring Boot и реактивного стека технологий: https://github.com/AlexForGH/Stage_2_2_SpringBootReactiveWebOnlineStore.git
#### Ссылка на следующий проект на основе Spring Boot и реактивного стека технологий с RESTful API, Open API и Spring Data Redis и Spring Security: https://github.com/AlexForGH/Stage_2_4_SpringBootReactiveWebOnlineStoreWithRESTfulAPIOpenAPIAndRedisAndSecurity.git
